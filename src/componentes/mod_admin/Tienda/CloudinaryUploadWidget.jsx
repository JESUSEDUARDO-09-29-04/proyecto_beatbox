...
const CloudinaryUploadWidget = ({ onUpload }) => {
  useEffect(() => {
    ...
    const existingScript = document.querySelector('script[src="http://widget.cloudinary.com/v2.0/global/all.js"]')
    ...
    const widget = window.cloudinary.createUploadWidget(
      {
        ...
        clientAllowedFormats: ["webp", "png", "jpg"], // Formatos permitidos
